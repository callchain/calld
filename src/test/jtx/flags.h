...
#ifndef CALL_TEST_JTX_FLAGS_H_INCLUDED
#define CALL_TEST_JTX_FLAGS_H_INCLUDED
...
private:
    ...
    set_args (std::uint32_t flag)
    {
        ...
        case asfDisallowCALL:    mask_ |= lsfDisallowCALL; break;
        ...
        case asfDefaultCall:  mask_ |= lsfDefaultCall; break;
        default:
