...
#include <call/rpc/impl/TransactionSign.h>
#include <test/jtx.h>
...
{ "Cannot create CALL to CALL paths.",
R"({
    "command": "doesnt_matter",
    "account": "rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",
    "secret": "masterpassphrase",
...
{ "Even though 'Amount' may not be CALL for pathfinding, 'SendMax' may be CALL.",
R"({
    "command": "doesnt_matter",
    "account": "rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",
    "secret": "masterpassphrase",
...
public:
    ...
    void testTransactionRPC ()
    {
        ...
        env.fund(test::jtx::CALL(100000), a, ed, g);
        env.close();
...
BEAST_DEFINE_TESTSUITE(JSONRPC,call_app,call);
