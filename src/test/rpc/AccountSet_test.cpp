...
public:
    ...
    void testBadInputs(bool withFeatures)
    {
        ...
        auto jt = fset(alice, asfDisallowCALL);
        jt[jss::ClearFlag] = asfDisallowCALL;
        ...
        jt = fset(alice, asfDisallowCALL);
        jt[sfFlags.fieldName] = tfAllowCALL;
        env(jt, ter(temINVALID_FLAG));
