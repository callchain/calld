...
class NoCallCheck_test : public beast::unit_test::suite
{
    ...
    testBadInput ()
    {
        testcase ("Bad input to nocall_check");
        ...
        { // missing account field
            auto const result = env.rpc ("json", "nocall_check", "{}")
                [jss::result];
    ...
    {
        testcase << "Request nocall_check for " <<
        ...
        params[jss::ledger] = "current";
        auto result = env.rpc ("json", "nocall_check",
            boost::lexical_cast<std::string>(params)) [jss::result];
        ...
        result = env.rpc ("json", "nocall_check",
            boost::lexical_cast<std::string>(params)) [jss::result];
