...
public:
    void testQueue()
    {
        ...
        env.fund(XRP(50000), nocall(alice, bob, charlie, daria));
        ...
        env.fund(XRP(50000), nocall(elmo, fred, gwen, hank));
    ...
    void testLocalTxRetry()
    {
        ...
        // Create several accounts while the fee is cheap so they all apply.
        env.fund(XRP(50000), nocall(alice, bob, charlie));
    ...
    void testLastLedgerSeq()
    {
        ...
        env.fund(XRP(1000), nocall(alice, bob));
        env.close(env.now() + 5s, 10000ms);
        env.fund(XRP(1000), nocall(charlie, daria));
        env.close(env.now() + 5s, 10000ms);
        env.fund(XRP(1000), nocall(edgar, felicia));
        env.close(env.now() + 5s, 10000ms);
    ...
    void testZeroFeeTxn()
    {
        ...
        env.fund(XRP(1000), nocall(alice, bob));
        env.close(env.now() + 5s, 10000ms);
        env.fund(XRP(1000), nocall(carol));
        env.close(env.now() + 5s, 10000ms);
    ...
    void testMultiTxnPerAccount()
    {
        ...
        env.fund(XRP(500000), nocall(bob, charlie, daria));
    ...
    void testDisabled()
    {
        ...
        env.fund(XRP(50000), nocall(alice));
    ...
    void testBlockers()
    {
        ...
        env.fund(XRP(50000), nocall(alice, bob));
        env.memoize(charlie);
        env.memoize(daria);
    ...
    void testInFlightBalance()
    {
        ...
        env.fund(XRP(50000), nocall(alice, charlie), gw);
        checkMetrics(env, 0, boost::none, 4, 3, 256);
    ...
    void testExpirationReplacement()
    {
        ...
        */
        ...
        env.fund(XRP(500000), nocall(alice, bob));
        checkMetrics(env, 0, boost::none, 2, 1, 256);
    ...
    void testServerSubscribe()
    {
        ...
        env.fund(XRP(50000), nocall(a,b,c,d));
        checkMetrics(env, 0, boost::none, 4, 3, 256);
        ...
        env.fund(XRP(50000), nocall(e,f,g,h,i));
