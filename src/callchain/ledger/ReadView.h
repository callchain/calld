...
#ifndef CALLCHAIN_LEDGER_READVIEW_H_INCLUDED
#define CALLCHAIN_LEDGER_READVIEW_H_INCLUDED

#include <callchain/ledger/detail/ReadViewFwdRange.h>
...
#include <callchain/ledger/detail/ReadViewFwdRange.ipp>
