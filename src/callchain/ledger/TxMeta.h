...
#ifndef CALLCHAIN_APP_TX_TRANSACTIONMETA_H_INCLUDED
#define CALLCHAIN_APP_TX_TRANSACTIONMETA_H_INCLUDED
...
// VFALCO Move to callchain/app/ledger/detail, rename to TxMeta
class TxMeta
{
public:
