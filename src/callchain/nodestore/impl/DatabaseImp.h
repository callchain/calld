...
#ifndef CALLCHAIN_NODESTORE_DATABASEIMP_H_INCLUDED
#define CALLCHAIN_NODESTORE_DATABASEIMP_H_INCLUDED

#include <callchain/nodestore/Database.h>
#include <callchain/nodestore/Scheduler.h>
#include <callchain/nodestore/impl/Tuning.h>
...
public:
    ...
    void storeInternal (NodeObjectType type,
                        ...
                        Backend& backend)
    {
        #if CALLCHAIN_VERIFY_NODEOBJECT_KEYS
