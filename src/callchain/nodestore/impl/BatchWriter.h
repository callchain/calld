...
#ifndef CALLCHAIN_NODESTORE_BATCHWRITER_H_INCLUDED
#define CALLCHAIN_NODESTORE_BATCHWRITER_H_INCLUDED

#include <callchain/nodestore/Scheduler.h>
#include <callchain/nodestore/Task.h>
#include <callchain/nodestore/Types.h>
