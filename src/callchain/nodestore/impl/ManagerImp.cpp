...
#include <callchain/nodestore/impl/ManagerImp.h>
#include <callchain/nodestore/impl/DatabaseRotatingImp.h>
...
ManagerImp::missing_backend()
{
    Throw<std::runtime_error> (
        "Your callchaind.cfg is missing a [node_db] entry, "
        "please see the callchaind-example.cfg file!"
        );
}
