...
#ifndef CALLCHAIN_UNITY_HYPERLEVELDB_H_INCLUDED
#define CALLCHAIN_UNITY_HYPERLEVELDB_H_INCLUDED

#include <beast/Config.h>

#if ! BEAST_WIN32

#define CALLCHAIN_HYPERLEVELDB_AVAILABLE 1
...
#define CALLCHAIN_HYPERLEVELDB_AVAILABLE 0
