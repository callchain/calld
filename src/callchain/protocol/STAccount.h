...
#ifndef CALLCHAIN_PROTOCOL_STACCOUNT_H_INCLUDED
#define CALLCHAIN_PROTOCOL_STACCOUNT_H_INCLUDED
...
private:
    ...
    // overhead in a callchain::uint160.  However, so the serialized format of the
