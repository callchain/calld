...
#ifndef CALLCHAIN_PROTOCOL_LEDGERFORMATS_H_INCLUDED
#define CALLCHAIN_PROTOCOL_LEDGERFORMATS_H_INCLUDED

#include <callchain/protocol/KnownFormats.h>
...
enum LedgerSpecificFlags
{
    ...
    lsfNoFreeze         = 0x00200000,   // True, cannot freeze callchain states
