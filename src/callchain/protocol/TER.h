...
#ifndef CALLCHAIN_PROTOCOL_TER_H_INCLUDED
#define CALLCHAIN_PROTOCOL_TER_H_INCLUDED
...
// See https://callchain.com/wiki/Transaction_errors
//
...
enum TER
{
    ...
    terNO_CALLCHAIN,        // Rippling not allowed
    ...
    // 100 .. 159 C
    //   Claim fee only (callchain transaction with no good paths, pay to
