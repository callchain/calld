...
#ifndef CALLCHAIN_PROTOCOL_ACCOUNTID_H_INCLUDED
#define CALLCHAIN_PROTOCOL_ACCOUNTID_H_INCLUDED

#include <callchain/protocol/tokens.h>
...
/** Caches the base58 representations of AccountIDs
    ...
    justify having a cache. In the future, callchaind should
...
public:
    ...
    /** Return callchain::toBase58 for the AccountID
...
template <>
struct hash <callchain::AccountID> : callchain::AccountID::hasher
{
};
