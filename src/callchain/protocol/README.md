...
In callchain objects transmitted over the network must be
serialized into a canonical format. The prefix "ST" refers
to classes that deal with the serialized format of callchain
objects.
...
([Real example](https://github.com/callchain/callchaind/blob/35f4698aed5dce02f771b34cfbb690495cb5efcc/src/callchain/app/tx/impl/PayChan.cpp#L229-L236))
