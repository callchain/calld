    ...
    void const* token, std::size_t size, bool btc)
{
    ...
    return encodeBase58(temp, expanded,
        temp + expanded, btc ? bitcoinAlphabet : callchainAlphabet);
}
...
static InverseAlphabet callchainInverse(callchainAlphabet);
