...
#ifndef CALLCHAIN_PROTOCOL_JSONFIELDS_H_INCLUDED
#define CALLCHAIN_PROTOCOL_JSONFIELDS_H_INCLUDED
...
JSS ( no_callchain );                  // out: AccountLines
JSS ( no_callchain_peer );             // out: AccountLines
...
JSS ( result );                     // RPC
JSS ( callchain_lines );               // out: NetworkOPs
JSS ( callchain_state );               // in: LedgerEntr
JSS ( callchainrpc );                  // callchain RPC version
