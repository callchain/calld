...
#ifndef CALLCHAIN_PROTOCOL_DIGEST_H_INCLUDED
#define CALLCHAIN_PROTOCOL_DIGEST_H_INCLUDED

#include <callchain/basics/base_uint.h>
#include <callchain/beast/crypto/ripemd.h>
#include <callchain/beast/crypto/sha2.h>
