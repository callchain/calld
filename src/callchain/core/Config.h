...
#ifndef CALLCHAIN_CORE_CONFIG_H_INCLUDED
#define CALLCHAIN_CORE_CONFIG_H_INCLUDED

#include <callchain/basics/BasicConfig.h>
#include <callchain/basics/base_uint.h>
#include <callchain/protocol/SystemParameters.h> // VFALCO Breaks levelization
...
public:
    ...
    std::vector<std::string>    IPS;                    // Peer IPs from callchaind.cfg.
    std::vector<std::string>    IPS_FIXED;              // Fixed Peer IPs from callchaind.cfg.
    std::vector<std::string>    SNTP_SERVERS;           // SNTP servers from callchaind.cfg.
