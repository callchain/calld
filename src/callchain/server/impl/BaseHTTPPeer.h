...
#ifndef CALLCHAIN_SERVER_BASEHTTPPEER_H_INCLUDED
#define CALLCHAIN_SERVER_BASEHTTPPEER_H_INCLUDED
...
#include <callchain/beast/asio/ssl_error.h> // for is_short_read?
