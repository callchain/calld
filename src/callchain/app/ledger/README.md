...
There are two ledgers that are the most important for a callchaind server to have:
...
the transaction increments the sequence number.  This is how callchain prevents
