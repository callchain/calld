...
#ifndef CALLCHAIN_APP_CONSENSUS_RCLCXLEDGER_H_INCLUDED
#define CALLCHAIN_APP_CONSENSUS_RCLCXLEDGER_H_INCLUDED
...
public:
    ...
    */
    ...
    closeAgree() const
    {
        return callchain::getCloseAgree(ledger_->info());
    }
    ...
    getJson() const
    {
        return callchain::getJson(*ledger_);
    }
