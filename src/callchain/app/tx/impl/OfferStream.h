...
#ifndef CALLCHAIN_APP_BOOK_OFFERSTREAM_H_INCLUDED
#define CALLCHAIN_APP_BOOK_OFFERSTREAM_H_INCLUDED

#include <callchain/app/tx/impl/BookTip.h>
#include <callchain/app/tx/impl/Offer.h>
