    ...
    STAmount const& amount)
{
    ...
    return callchain::transferXRP (view_, from, to, amount, journal_);
}
    ...
    Issue const& issue)
{
    ...
    auto ret = callchain::redeemIOU (view_, account, amount, issue, journal_);
    ...
    Issue const& issue)
{
    ...
    return callchain::issueIOU (view_, account, amount, issue, journal_);
}
