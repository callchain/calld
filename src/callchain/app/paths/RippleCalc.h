...
#ifndef CALLCHAIN_APP_PATHS_CALLCHAINCALC_H_INCLUDED
#define CALLCHAIN_APP_PATHS_CALLCHAINCALC_H_INCLUDED
...
private:
    ...
    TER callchainCalculate (detail::FlowDebugInfo* flowDebugInfo=nullptr);
