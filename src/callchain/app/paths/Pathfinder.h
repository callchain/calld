...
#ifndef CALLCHAIN_APP_PATHS_PATHFINDER_H_INCLUDED
#define CALLCHAIN_APP_PATHS_PATHFINDER_H_INCLUDED

#include <callchain/app/ledger/Ledger.h>
#include <callchain/app/paths/RippleLineCache.h>
#include <callchain/core/LoadEvent.h>
...
private:
    ...
    // set the "no callchain" flag on the link?
    bool isNoRippleOut (STPath const& currentPath);

    // Is the "no callchain" flag set from one account to another?
    bool isNoRipple (
