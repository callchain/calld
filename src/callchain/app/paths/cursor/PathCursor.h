...
#ifndef CALLCHAIN_APP_PATHS_CURSOR_PATHCURSOR_H_INCLUDED
#define CALLCHAIN_APP_PATHS_CURSOR_PATHCURSOR_H_INCLUDED
...
private:
    ...
    {
        return {callchainCalc_, pathState_, multiQuality_, j_, nodeIndex_ + delta};
    }
