...
TER PathCursor::forwardLiquidityForAccount () const
{
    ...
    if (previousNode().isAccount() && nextNode().isAccount())
    {
        ...
        if (!nodeIndex_)
        {
            ...
            // For the first node, calculate amount to callchain based on what is
            // available.
        ...
        else if (nodeIndex_ == lastNodeIndex)
        {
            ...
            {
                // Actually receive.
                resultCode = callchainCredit(view(),
                    previousAccountID,
                    node().account_,
    ...
    else if (previousNode().isAccount() && !nextNode().isAccount())
    {
        ...
        else
        {
            ...
            else if (!isXRP (node().issue_))
            {
                ...
                // which callchain balance will be adjusted.  Assume just issuing.
