...
#ifndef CALLCHAIN_PATH_IMPL_FLOWDEBUGINFO_H_INCLUDED
#define CALLCHAIN_PATH_IMPL_FLOWDEBUGINFO_H_INCLUDED
        ...
        if (writePassInfo)
        {
            ...
            auto writeXrpAmtList = [&write_list](
                ...
                auto get_val = [](EitherAmount const& a) -> std::string {
                    return callchain::to_string (a.xrp);
                };
            ...
            auto writeIouAmtList = [&write_list](
                std::vector<EitherAmount> const& amts, char delim=';') {
                auto get_val = [](EitherAmount const& a) -> std::string {
                    return callchain::to_string (a.iou);
                };
                write_list (amts, get_val, delim);
            };
