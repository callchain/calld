...
#ifndef CALLCHAIN_APP_PATHS_IMPL_PAYSTEPS_H_INCLUDED
#define CALLCHAIN_APP_PATHS_IMPL_PAYSTEPS_H_INCLUDED
...
struct StrandContext
{
    ...
    /** The previous step in the strand. Needed to check the no callchain
        constraint
     */
...
bool bookStepEqual (Step const& step, callchain::Book const& book);
}
