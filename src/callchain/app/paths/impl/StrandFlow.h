...
#ifndef CALLCHAIN_APP_PATHS_IMPL_STRANDFLOW_H_INCLUDED
#define CALLCHAIN_APP_PATHS_IMPL_STRANDFLOW_H_INCLUDED

#include <BeastConfig.h>
#include <callchain/app/paths/Credit.h>
#include <callchain/app/paths/Flow.h>
#include <callchain/app/paths/impl/AmountSpec.h>
#include <callchain/app/paths/impl/FlowDebugInfo.h>
#include <callchain/app/paths/impl/Steps.h>
#include <callchain/basics/Log.h>
#include <callchain/protocol/IOUAmount.h>
#include <callchain/protocol/XRPAmount.h>
...
/**
   ...
   @param strand Steps of Accounts to callchain through and offer books to use
...
/**
   ...
   @param baseView Trust lines and balances
   @param strands Each strand contains the steps of accounts to callchain through
