...
#ifndef CALLCHAIN_APP_MISC_MANIFEST_H_INCLUDED
#define CALLCHAIN_APP_MISC_MANIFEST_H_INCLUDED
...
/*
    ...
    EVERY callchaind needs to have its config updated with the new public keys, and
    ...
    received from callchaind peers.
    ...
    signed by the master key.  When a callchaind peer receives the new manifest,
