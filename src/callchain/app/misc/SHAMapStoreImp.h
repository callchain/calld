...
#ifndef CALLCHAIN_APP_MISC_SHAMAPSTOREIMP_H_INCLUDED
#define CALLCHAIN_APP_MISC_SHAMAPSTOREIMP_H_INCLUDED

#include <callchain/app/misc/SHAMapStore.h>
#include <callchain/app/ledger/LedgerMaster.h>
#include <callchain/core/DatabaseCon.h>
#include <callchain/nodestore/DatabaseRotating.h>
...
private:
    ...
    std::string const dbPrefix_ = "callchaindb";
...
private:
    ...
    // If callchaind is not healthy, defer rotate-delete.
