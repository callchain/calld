...
#ifndef CALLCHAIN_APP_MISC_NETWORKOPS_H_INCLUDED
#define CALLCHAIN_APP_MISC_NETWORKOPS_H_INCLUDED
...
#include <callchain/net/InfoSub.h>
...
/** Provides server functionality for clients.
    ...
    callchaind / NetworkOPs. However, client software connecting to non-local
    instances of callchaind will need to be hardened to protect against hostile
