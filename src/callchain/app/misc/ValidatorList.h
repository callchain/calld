...
#ifndef CALLCHAIN_APP_MISC_VALIDATORLIST_H_INCLUDED
#define CALLCHAIN_APP_MISC_VALIDATORLIST_H_INCLUDED
...
/**
    ...
    This class manages the set of validation public keys the local callchaind node
