...
#ifndef CALLCHAIN_PEERFINDER_SLOTIMP_H_INCLUDED
#define CALLCHAIN_PEERFINDER_SLOTIMP_H_INCLUDED

#include <callchain/peerfinder/Slot.h>
#include <callchain/peerfinder/PeerfinderManager.h>
#include <callchain/beast/core/CompilerConfig.h>
