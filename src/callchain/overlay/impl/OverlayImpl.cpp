...
#include <callchain/overlay/impl/ConnectAttempt.h>
#include <callchain/overlay/impl/PeerImp.h>
#include <callchain/peerfinder/make_Manager.h>
...
OverlayImpl::onPrepare()
{
    ...
    if (bootstrapIps.empty ())
        bootstrapIps.push_back ("r.callchain.com 51235");
    ...
    // Add the ips_fixed from the callchaind.cfg file
