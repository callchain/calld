...
#ifndef CALLCHAIN_OVERLAY_PEERIMP_H_INCLUDED
#define CALLCHAIN_OVERLAY_PEERIMP_H_INCLUDED

#include <callchain/app/consensus/RCLCxPeerPos.h>
#include <callchain/basics/Log.h>
#include <callchain/beast/core/ByteOrder.h>
#include <callchain/beast/utility/WrappedSink.h>
#include <callchain/overlay/impl/ProtocolMessage.h>
#include <callchain/overlay/impl/OverlayImpl.h>
...
public:
    ...
    */
    ...
    /** Return the version of callchaind that the peer is running, if reported. */
    std::string
    getVersion() const;
