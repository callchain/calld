...
#include <callchain/rpc/impl/LegacyPathFind.h>
...
Json::Value doRipplePathFind (RPC::Context& context)
{
        ...
        ! context.params.isMember(jss::ledger_hash))
    {
        ...
        //    callchain_path_find.  doRipplePathFind() is currently running
        ...
        // callchaind source code) shutting down the application.  The code to
