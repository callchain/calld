...
#ifndef CALLCHAIN_RPC_HANDLERS_LEDGER_H_INCLUDED
#define CALLCHAIN_RPC_HANDLERS_LEDGER_H_INCLUDED
...
#include <callchain/rpc/impl/Handler.h>
#include <callchain/rpc/Role.h>
