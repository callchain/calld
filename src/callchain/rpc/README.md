...
For this purpose, the callchaind RPC handler allows *suspension with continuation*
...
Suspension with continuation uses four `std::function`s in the `callchain::RPC`
namespace:
