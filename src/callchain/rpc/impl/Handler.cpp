...
#include <callchain/rpc/handlers/Version.h>
...
Handler handlerArray[] {
    ...
    {   "nocallchain_check",       byRef (&doNoRippleCheck),       Role::USER,  NO_CONDITION  },
...
//      {   "profile",              byRef (&doProfile),             Role::USER,  NEEDS_CURRENT_LEDGER  },
    ...
    {   "callchain_path_find",     byRef (&doRipplePathFind),      Role::USER,  NO_CONDITION  },
