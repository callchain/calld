...
#ifndef CALLCHAIN_BASICS_BYTEORDER_H_INCLUDED
#define CALLCHAIN_BASICS_BYTEORDER_H_INCLUDED
...
// VFALCO These are all deprecated please use the ones in <callchain/beast/core/ByteOrder.h>
