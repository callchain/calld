...
#ifndef CALLCHAIN_BASICS_BASE_UINT_H_INCLUDED
#define CALLCHAIN_BASICS_BASE_UINT_H_INCLUDED

#include <callchain/basics/ByteOrder.h>
#include <callchain/basics/Blob.h>
...
template <std::size_t Bits, class Tag>
struct is_uniquely_represented<callchain::base_uint<Bits, Tag>>
