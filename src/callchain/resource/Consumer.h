...
#ifndef CALLCHAIN_RESOURCE_CONSUMER_H_INCLUDED
#define CALLCHAIN_RESOURCE_CONSUMER_H_INCLUDED

#include <callchain/resource/Charge.h>
#include <callchain/resource/Disposition.h>
