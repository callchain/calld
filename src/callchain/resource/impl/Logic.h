...
#ifndef CALLCHAIN_RESOURCE_LOGIC_H_INCLUDED
#define CALLCHAIN_RESOURCE_LOGIC_H_INCLUDED

#include <callchain/resource/Fees.h>
#include <callchain/resource/Gossip.h>
#include <callchain/resource/impl/Import.h>
