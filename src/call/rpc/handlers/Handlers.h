...
#ifndef CALL_RPC_HANDLERS_HANDLERS_H_INCLUDED
#define CALL_RPC_HANDLERS_HANDLERS_H_INCLUDED

#include <call/rpc/handlers/LedgerHandler.h>
...
Json::Value doContractInfo          (RPC::Context&);
