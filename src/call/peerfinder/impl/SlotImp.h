...
#ifndef CALL_PEERFINDER_SLOTIMP_H_INCLUDED
#define CALL_PEERFINDER_SLOTIMP_H_INCLUDED

#include <call/peerfinder/Slot.h>
#include <call/peerfinder/PeerfinderManager.h>
#include <call/beast/core/CompilerConfig.h>
