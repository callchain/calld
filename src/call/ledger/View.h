...
#ifndef CALL_LEDGER_VIEW_H_INCLUDED
#define CALL_LEDGER_VIEW_H_INCLUDED

#include <call/ledger/ApplyView.h>
...
// Return the account's liquid (not reserved) CALL.  Generally prefer
