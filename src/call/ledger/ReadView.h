...
#ifndef CALL_LEDGER_READVIEW_H_INCLUDED
#define CALL_LEDGER_READVIEW_H_INCLUDED

#include <call/ledger/detail/ReadViewFwdRange.h>
...
struct Fees
{
    ...
    std::uint64_t commission = 0;   // Commission fee for inviter
...
#include <call/ledger/detail/ReadViewFwdRange.ipp>
