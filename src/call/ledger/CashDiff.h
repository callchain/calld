...
#ifndef CALL_LEDGER_CASHDIFF_H_INCLUDED
#define CALL_LEDGER_CASHDIFF_H_INCLUDED
...
// If both v1 and v2 are CALL, any difference of 2 or smaller is considered dust.
