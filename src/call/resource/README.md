...
additional CALL for transactions, requiring a proof of work to be
...
overlay network implementing the Call protocol.
...
In calld, the Application holds a unique instance of Resource::Manager,
