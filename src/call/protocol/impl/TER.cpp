...
transResults()
{
    ...
    results
    {
        ...
        { tecNO_DST,                 { "tecNO_DST",                "Destination does not exist. Send CALL to create it."                           } },
        { tecNO_DST_INSUF_CALL,      { "tecNO_DST_INSUF_CALL",     "Destination does not exist. Too little CALL sent to create it."                } },
        ...
        { tecUNFUNDED_ADD,           { "tecUNFUNDED_ADD",          "Insufficient CALL balance for WalletAdd."                                      } },
	    ...
	    { tecOVERISSUED_AMOUNT,      { "tecOVERISSUED_AMOUNT",     "the issued amount is greater than the total amount."                           } },
        ...
        { temBAD_FEE,                { "temBAD_FEE",               "Invalid fee, negative or not CALL."                                            } },
        ...
        { temBAD_SEND_CALL_LIMIT,    { "temBAD_SEND_CALL_LIMIT",    "Malformed: Limit quality is not allowed for CALL to CALL."                    } },
        { temBAD_SEND_CALL_MAX,      { "temBAD_SEND_CALL_MAX",      "Malformed: Send max is not allowed for CALL to CALL."                         } },
        { temBAD_SEND_CALL_NO_DIRECT,{ "temBAD_SEND_CALL_NO_DIRECT","Malformed: No Call direct is not allowed for CALL to CALL."                   } },
        { temBAD_SEND_CALL_PARTIAL,  { "temBAD_SEND_CALL_PARTIAL",  "Malformed: Partial payment is not allowed for CALL to CALL."                  } },
        { temBAD_SEND_CALL_PATHS,    { "temBAD_SEND_CALL_PATHS",    "Malformed: Paths are not allowed for CALL to CALL."                           } },
        ...
        { temINVOICE_NO_FEE,         { "temINVOICE_NO_FEE",        "Invoice not support transfer fee"                                              } },
        { temCURRENCY_NOT_ISSUE,     { "temCURRENCY_NOT_ISSUE",    "Issuer not issue such currency yet"                                            } },
        { temSELF_TRUST,             { "temSELF_TRUST",            "Not allow to self trust"                                                       } },
        { temNOT_ADDITIONAL,         { "temNOT_ADDITIONAL",        "IssueSet amount not allow to additional issue"                                 } },
        { temBAD_INVOICE_AMOUNT,     { "temBAD_INVOICE_AMOUNT",    "Invoice amount should be integer one"                                          } },
        { temINVOICE_NOT_ACCOUNT,    { "temINVOICE_NOT_ACCOUNT",   "Account not have such invoice"                                                 } },
        ...
        { terNO_CALL,                { "terNO_CALL",               "Path does not permit calling."                                                 } },
        ...
        { tecINVALID_PARAM_NUMS,     { "tecINVALID_PARAM_NUMS",    "Invalid function parameter number."                                            } },
        { tecINVALID_PARAM_TYPE,     { "tecINVALID_PARAM_TYPE",    "Invalid function parameter type."                                              } },
        { tecINVALID_PARAM_ACCOUNT,  { "tedINVALID_PRARM_ACCOUNT", "Invalid account parameter."                                                    } },
        { tecACCOUNT_NOT_FOUND,      { "tecACCOUNT_NOT_FOUND",     "Account not found."                                                            } },
        { tecINVALID_KEY_TYPE,       { "tecINVALID_KEY_TYPE",      "Invalid key type."                                                             } },
        { tecINVALID_VALUE_TYPE,     { "tecINVALID_VALUE_TYPE",    "Invalid value type."                                                           } },
        { tecINVALID_AMOUNT,         { "tecINVALID_AMOUNT",        "Invalid amount."                                                               } },
        { tecSEND_CONTRACT_SELF,     { "tecSEND_CONTRACT_SELF",    "Not allow to send to contract self."                                           } },
        { tecINVALID_DESTINATION,    { "tecINVALID_DESTINATION",   "Invalid destination account."                                                  } },
        { tecNO_SUCH_VALUE,          { "tecNO_SUCH_VALUE",         "No such value saved."                                                          } },
        { tecCODE_FEE_OUT,           { "tecCODE_FEE_OUT",          "Fee run out in code execute"                                                   } },
        { tecINVALID_PARAM_ISSUER,   { "tecINVALID_PARAM_ISSUER",  "Invalid function parameter issuer."                                            } },
        { tecCODE_LOAD_FAILED,       { "tecCODE_LOAD_FAILED",      "Fail to load account code."                                                    } },
