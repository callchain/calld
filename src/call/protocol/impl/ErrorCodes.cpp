...
template <>
struct hash <call::error_code_i>
{
    std::size_t operator() (call::error_code_i value) const
    {
        return value;
    }
};
...
public:
        ...
        : m_unknown (rpcUNKNOWN, "unknown", "An unknown error code.")
    {
        ...
        add (rpcNO_NETWORK,            "noNetwork",         "Not synced to Call network.");
        add (rpcNO_PATH,               "noPath",            "Unable to find a call path.");
        ...
        add (rpcNICKACCOUNT_NOT_FOUND, "nonickaccountnot",  "nick account is not existed.");
    }
