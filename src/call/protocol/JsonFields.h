...
#ifndef CALL_PROTOCOL_JSONFIELDS_H_INCLUDED
#define CALL_PROTOCOL_JSONFIELDS_H_INCLUDED
...
JSS ( no_call );                  // out: AccountLines
JSS ( no_call_peer );             // out: AccountLines
...
JSS ( call_state );               // in: LedgerEntr
JSS ( callrpc );                  // call RPC version
