...
#ifndef CALL_PROTOCOL_PUBLICKEY_H_INCLUDED
#define CALL_PROTOCOL_PUBLICKEY_H_INCLUDED

#include <call/basics/Slice.h>
#include <call/crypto/KeyType.h> // move to protocol/
...
/** A public key.
    ...
    The format of the public key is Call specific,
