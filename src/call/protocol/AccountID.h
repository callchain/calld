...
#ifndef CALL_PROTOCOL_ACCOUNTID_H_INCLUDED
#define CALL_PROTOCOL_ACCOUNTID_H_INCLUDED

#include <call/protocol/tokens.h>
...
/** A special account that's used as the "issuer" for CALL. */
AccountID const&
callAccount();
...
/** Caches the base58 representations of AccountIDs
    ...
    justify having a cache. In the future, calld should
...
public:
    ...
    /** Return call::toBase58 for the AccountID
...
template <>
struct hash <call::AccountID> : call::AccountID::hasher
{
};
