...
#ifndef CALL_PROTOCOL_SFIELD_H_INCLUDED
#define CALL_PROTOCOL_SFIELD_H_INCLUDED
...
extern SF_U256 const sfTakerPaysInvoiceID;
extern SF_U256 const sfTakerGetsInvoiceID;
