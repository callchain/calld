...
#ifndef CALL_PROTOCOL_UINTTYPES_H_INCLUDED
#define CALL_PROTOCOL_UINTTYPES_H_INCLUDED
...
template <>
struct hash <call::Currency> : call::Currency::hasher
{
};

template <>
struct hash <call::NodeID> : call::NodeID::hasher
{
};

template <>
struct hash <call::Directory> : call::Directory::hasher
{
};
