...
#ifndef CALL_APP_LEDGER_LEDGERTIMING_H_INCLUDED
#define CALL_APP_LEDGER_LEDGERTIMING_H_INCLUDED
...
/** Calculates the close time resolution for the specified ledger.
    ...
    The Call protocol uses binning to represent time intervals using only one
