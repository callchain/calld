...
#ifndef CALL_UNITY_HYPERLEVELDB_H_INCLUDED
#define CALL_UNITY_HYPERLEVELDB_H_INCLUDED

#include <beast/Config.h>

#if ! BEAST_WIN32

#define CALL_HYPERLEVELDB_AVAILABLE 1
...
#define CALL_HYPERLEVELDB_AVAILABLE 0
