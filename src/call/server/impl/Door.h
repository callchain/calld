...
#ifndef CALL_SERVER_DOOR_H_INCLUDED
#define CALL_SERVER_DOOR_H_INCLUDED

#include <call/server/impl/io_list.h>
#include <call/basics/contract.h>
#include <call/basics/Log.h>
#include <call/server/impl/PlainHTTPPeer.h>
#include <call/server/impl/SSLHTTPPeer.h>
#include <call/beast/asio/ssl_bundle.h>
