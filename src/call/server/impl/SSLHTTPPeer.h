...
#ifndef CALL_SERVER_SSLHTTPPEER_H_INCLUDED
#define CALL_SERVER_SSLHTTPPEER_H_INCLUDED

#include <call/server/impl/BaseHTTPPeer.h>
#include <call/server/impl/SSLWSPeer.h>
