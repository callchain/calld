...
#include <call/nodestore/impl/ManagerImp.h>
#include <call/nodestore/impl/DatabaseRotatingImp.h>
...
ManagerImp::missing_backend()
{
    Throw<std::runtime_error> (
        "Your calld.cfg is missing a [node_db] entry, "
        "please see the calld-example.cfg file!"
        );
}
