...
#ifndef CALL_NODESTORE_DATABASEIMP_H_INCLUDED
#define CALL_NODESTORE_DATABASEIMP_H_INCLUDED

#include <call/nodestore/Database.h>
#include <call/nodestore/Scheduler.h>
#include <call/nodestore/impl/Tuning.h>
...
public:
    ...
    void storeInternal (NodeObjectType type,
                        ...
                        Backend& backend)
    {
        #if CALL_VERIFY_NODEOBJECT_KEYS
