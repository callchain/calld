...
fully connected directed graph of nodes where vertices are instances of calld
...
* _User Defined_ (Unimplemented)
    ...
    The calld operator may specify additional, optional fields and values
...
Cluster members are configured in the `calld.cfg` file under
