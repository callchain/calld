...
#ifndef CALL_OVERLAY_PEERIMP_H_INCLUDED
#define CALL_OVERLAY_PEERIMP_H_INCLUDED

#include <call/app/consensus/RCLCxPeerPos.h>
#include <call/basics/Log.h>
#include <call/beast/core/ByteOrder.h>
#include <call/beast/utility/WrappedSink.h>
#include <call/overlay/impl/ProtocolMessage.h>
#include <call/overlay/impl/OverlayImpl.h>
...
public:
    ...
    */
    ...
    enum class State
    {
        ...
        /** Running the Call protocol actively */
        ,active
    };
...
public:
    ...
    */
    ...
    /** Return the version of calld that the peer is running, if reported. */
    std::string
    getVersion() const;
