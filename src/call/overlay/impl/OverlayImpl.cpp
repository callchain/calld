...
#include <call/overlay/impl/ConnectAttempt.h>
#include <call/overlay/impl/PeerImp.h>
#include <call/peerfinder/make_Manager.h>
...
OverlayImpl::onPrepare()
{
    ...
    if (bootstrapIps.empty ())
        bootstrapIps.push_back ("r.call.com 51235");
    ...
    // Add the ips_fixed from the calld.cfg file
...
/** The number of active peers on the network
    ...
    and are running the Call protocol.
*/
std::size_t
OverlayImpl::size()
{
