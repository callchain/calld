...
#include <call/beast/clock/basic_seconds_clock.h>
#include <call/beast/core/CurrentThreadName.h>
#include <call/beast/core/Time.h>
#include <call/beast/utility/Debug.h>
...
void printHelp (const po::options_description& desc)
{
    std::cerr
        ...
        << "Commands: \n"
           ...
           "     account_tokens <account> <account>|\"\" [<ledger>]\n"
...
int run (int argc, char** argv)
{
    ...
    beast::setCurrentThreadName ("calld: main");
    ...
    {
        std::cerr << "calld: Incorrect command line syntax." << std::endl;
    ...
    beast::setCurrentThreadName ("calld: rpc");
...
int main (int argc, char** argv)
{
...
#ifdef _MSC_VER
    call::sha512_deprecatedMSVCWorkaround();
#endif
    ...
    static_assert (gccver >= 50100,
        "GCC version 5.1.0 or later is required to compile calld.");
#endif

    static_assert (BOOST_VERSION >= 105700,
        "Boost version 1.57 or later is required to compile calld");
    ...
    std::set_terminate(call::terminateHandler);

    auto const result (call::run (argc, argv));
