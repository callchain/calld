...
#ifndef CALL_APP_PATHS_IMPL_PAYSTEPS_H_INCLUDED
#define CALL_APP_PATHS_IMPL_PAYSTEPS_H_INCLUDED
...
public:
    ...
    */
    ...
    /**
       ...
       account. This is needed for checkNoCall.
    */
...
struct StrandContext
{
    ...
    /** The previous step in the strand. Needed to check the no call
        constraint
     */
