...
#ifndef CALL_APP_PATHS_IMPL_STRANDFLOW_H_INCLUDED
#define CALL_APP_PATHS_IMPL_STRANDFLOW_H_INCLUDED
...
/**
   ...
   @param strand Steps of Accounts to call through and offer books to use
...
/**
   ...
   @param baseView Trust lines and balances
   @param strands Each strand contains the steps of accounts to call through
