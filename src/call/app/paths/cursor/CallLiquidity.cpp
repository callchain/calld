    ...
    std::uint64_t& uRateMax)
{
    ...
    if (qualityIn >= qualityOut)
    {
        ...
        JLOG (callCalc.j_.trace()) << "callLiquidity: No fees";
    ...
    else
    {
        ...
        JLOG (callCalc.j_.trace()) << "callLiquidity: Fee";
        ...
        if (!uRateMax || uRate <= uRateMax)
        {
            ...
            else
            {
                ...
                JLOG (callCalc.j_.trace())
                    << "callLiquidity:4: saCurReq=" << saCurReq;
...
quality_in (
    ...
    Currency const& currency)
{
    return callQuality (view, uToAccountID, uFromAccountID, currency,
