...
#ifndef CALL_APP_CONSENSUS_RCLCXLEDGER_H_INCLUDED
#define CALL_APP_CONSENSUS_RCLCXLEDGER_H_INCLUDED
...
public:
    ...
    */
    ...
    closeAgree() const
    {
        return call::getCloseAgree(ledger_->info());
    }
