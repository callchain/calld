...
#ifndef CALL_APP_MISC_SHAMAPSTOREIMP_H_INCLUDED
#define CALL_APP_MISC_SHAMAPSTOREIMP_H_INCLUDED

#include <call/app/misc/SHAMapStore.h>
#include <call/app/ledger/LedgerMaster.h>
#include <call/core/DatabaseCon.h>
#include <call/nodestore/DatabaseRotating.h>
...
private:
    ...
    std::string const dbPrefix_ = "calldb";
...
private:
    ...
    // If calld is not healthy, defer rotate-delete.
