...
#ifndef CALL_APP_MISC_DETAIL_WORKSSL_H_INCLUDED
#define CALL_APP_MISC_DETAIL_WORKSSL_H_INCLUDED

#include <call/app/misc/detail/WorkBase.h>
#include <call/net/RegisterSSLCerts.h>
