...
#ifndef CALL_APP_MISC_NETWORKOPS_H_INCLUDED
#define CALL_APP_MISC_NETWORKOPS_H_INCLUDED
...
/** Provides server functionality for clients.
    ...
    calld / NetworkOPs. However, client software connecting to non-local
    instances of calld will need to be hardened to protect against hostile
