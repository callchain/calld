...
native currency, CALL. Fees for transactions are paid directly from the account
...
may want to change fees is when the value of the native currency CALL fluctuates
...
A validating instance of calld uses information in the configuration file
...
consensus to succeed, otherwise different instances of calld will get 
...
*  A pull request is created and the new code is folded into a calld build 
