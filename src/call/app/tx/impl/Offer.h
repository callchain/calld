...
#ifndef CALL_APP_BOOK_OFFER_H_INCLUDED
#define CALL_APP_BOOK_OFFER_H_INCLUDED
...
template<>
inline
void TOffer<IOUAmount, CALLAmount>::setFieldAmounts ()
{
    m_entry->setFieldAmount (sfTakerPays, toSTAmount(m_amounts.in, issIn_));
...
template<>
inline
void TOffer<CALLAmount, IOUAmount>::setFieldAmounts ()
{
