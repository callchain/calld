...
#include <call/app/tx/impl/Transfer.h>
...
TER Transfer::preflight(PreflightContext const &ctx)
{
...
TER Transfer::preclaim(PreclaimContext const &ctx)
{
	return tesSUCCESS;
}

TER Transfer::doApply()
{
