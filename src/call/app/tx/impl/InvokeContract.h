...
#ifndef CALL_TX_INVOKECONTRACT_H_INCLUDED
#define CALL_TX_INVOKECONTRACT_H_INCLUDED
...
namespace call
{
class InvokeContract : public Transactor
{
  public:
	...
	InvokeContract(ApplyContext &ctx) : Transactor(ctx)
	{
	}
