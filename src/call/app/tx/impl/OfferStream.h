...
#ifndef CALL_APP_BOOK_OFFERSTREAM_H_INCLUDED
#define CALL_APP_BOOK_OFFERSTREAM_H_INCLUDED

#include <call/app/tx/impl/BookTip.h>
#include <call/app/tx/impl/Offer.h>
