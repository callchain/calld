...
#ifndef CALL_TX_CREATECONTRACT_H_INCLUDED
#define CALL_TX_CREATECONTRACT_H_INCLUDED
...
namespace call
{
class CreateContract : public Transactor
{
  public:
	...
	CreateContract(ApplyContext &ctx) : Transactor(ctx)
	{
	}
