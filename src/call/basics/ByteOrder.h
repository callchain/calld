...
#ifndef CALL_BASICS_BYTEORDER_H_INCLUDED
#define CALL_BASICS_BYTEORDER_H_INCLUDED
...
// VFALCO These are all deprecated please use the ones in <call/beast/core/ByteOrder.h>
