...
#ifndef CALL_BASICS_BASE_UINT_H_INCLUDED
#define CALL_BASICS_BASE_UINT_H_INCLUDED

#include <call/basics/ByteOrder.h>
...
template <std::size_t Bits, class Tag>
struct is_uniquely_represented<call::base_uint<Bits, Tag>>
